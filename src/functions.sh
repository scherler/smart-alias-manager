#!/bin/zsh
# Core functions from alias-optimized.sh
# These are loaded separately from packs due to JSON encoding complexity
...
# ============================================
# JENKINS RUN FUNCTION
# ============================================

# Enhanced Jenkins run function - unified launcher with port checking
function jrun {
    local port="8080"
    local product=""
    ...
    if [[ -z "$product" ]]; then
        ...
        local products=(core-cm core-mm core-oc core-cc)
        local i=1
...
# ============================================
# MAVEN DEBUG FUNCTION
# ============================================

# Run specific Maven test in debug mode
function xx {
    mvn clean test -Dtest="$1" -Dmaven.surefire.debug
}
...
function docker-cleanup {
    ...
    echo "🗑️  Removing containers, images, volumes..."
    docker system prune -af --volumes
    echo "✅ Docker cleanup complete!"
}

# ============================================
# INTEGRATION ENVIRONMENT FUNCTION
# ============================================

# Complex chain - starts full integration environment
function bis {
    sudo service docker restart && \
    yarn start:integration-env && \
